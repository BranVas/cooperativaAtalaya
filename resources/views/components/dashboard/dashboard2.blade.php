    ...
    <div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
            ...
            <li class="nav-item"><a class="nav-link" href="colors.html">
                    <svg class="nav-icon">
                        <use xlink:href="/icons/sprites/free.svg#cil-drop"></use>
                    </svg> Colors</a></li>
                            ...
                            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="fs-4 fw-semibold">26K <span class="fs-6 fw-normal">(-12.4%
                                            <svg class="icon">
                                                <use
                                                    xlink:href="/icons/sprites/free.svg#cil-arrow-bottom">
                                                </use>
                                            </svg>)</span></div>
                                    <div>Users</div>
                                </div>
                            ...
                            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="fs-4 fw-semibold">$6.200 <span class="fs-6 fw-normal">(40.9%
                                            <svg class="icon">
                                                <use
                                                    xlink:href="/icons/sprites/free.svg#cil-arrow-top">
                                                </use>
                                            </svg>)</span></div>
                                    <div>Income</div>
                                </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="btn-toolbar d-none d-md-block" role="toolbar"
                                ...
                                <button class="btn btn-primary" type="button">
                                    <svg class="icon">
                                        <use
                                            xlink:href="/icons/sprites/free.svg#cil-cloud-download">
                                        </use>
                                    </svg>
                                </button>
                            </div>
                                        ...
                                        <thead class="fw-semibold text-nowrap">
                                            <tr class="align-middle">
                                                <th class="bg-body-secondary text-center">
                                                    <svg class="icon" width="24" height="24"> <use xlink:href="/icons/sprites/free.svg#cil-home"></use> </svg>
                                                </th>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        <button class="btn btn-transparent p-0" type="button"
                                                            ...
                                                            <svg class="icon">
                                                                <use
                                                                    xlink:href="/icons/sprites/free.svg#cil-options">
                                                                </use>
                                                            </svg>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-end"><a
