...
<head>
    <!-- CSS personalizado -->
    <link rel="stylesheet" href="css/mycss/adaptacionLateral.css">
    ...
    <link rel="stylesheet" href="css/mycss/simplebar.scss">
    <!-- Main styles for this application-->
    <link href="css/coreui/style.scss" rel="stylesheet">
    <!-- We use those styles to show code examples, you should remove them in your application.-->
    <link href="css/coreui/examples.scss" rel="stylesheet">
    <script src="js/coreui/config.js"></script>
    <script src="js/coreui/color-modes.js"></script>
...
<body>
                    ...
                    <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                        ...
                        <ul class="nav-group-items compact">
                            ...
                            <li class="nav-item"><a class="nav-link" href="base/tables.html"><span
                                        class="nav-icon"><span class="nav-icon-bullet"></span></span> Tables</a></li>
                    ...
                    <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                        ...
                        <ul class="nav-group-items compact">
                            ...
                            <li class="nav-item"><a class="nav-link"
                                    ...
                                    target="_blank"><span class="nav-icon"><span
    ...
    <!-- Cuerpo/cabecera-->
    <header><!-- ver donde se esta dando ese espacio de sobra grande-->
                ...
                <header class="header header-sticky p-0 mb-4">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="--cui-dropdown-min-width: 8rem;">
                                    ...
                                    <li>
                                        <button class="dropdown-item d-flex align-items-center active" type="button"
                                            ...
                                            <svg class="icon icon-lg me-3">
                                                <use xlink:href="/icons/sprites/free.svg#cil-contrast">
                                                </use>
                                            </svg>Auto
                                        </button>
                                    </li>
                    ...
                    <div class="dropdown-menu dropdown-menu-end pt-0">
                        <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold rounded-top mb-2">
                            Account de {{ Auth::user()->name }}</div><a class="dropdown-item" href="#">
                            <svg class="icon me-2">
                                <use xlink:href="/icons/sprites/free.svg#cil-bell"></use>
                            </svg> Updates<span class="badge badge-sm bg-info ms-2">42</span></a><a
                            class="dropdown-item" href="#">
                            <svg class="icon me-2">
                                <use xlink:href="/icons/sprites/free.svg#cil-envelope-open">
                                </use>
                            ...
                            class="dropdown-item" href="#">
                            <svg class="icon me-2">
                                <use xlink:href="/icons/sprites/free.svg#cil-comment-square">
                                </use>
                        ...
                        <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold my-2">
                            ...
                            <svg class="icon me-2">
                                <use xlink:href="/icons/sprites/free.svg#cil-credit-card">
                                </use>
                        ...
                        <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
                            <svg class="icon me-2">
                                <use xlink:href="/icons/sprites/free.svg#cil-lock-locked">
                                </use>
                        ...
                        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                            <div>
                                <div class="fs-4 fw-semibold">26K <span class="fs-6 fw-normal">(-12.4%
                                        <svg class="icon">
                                            <use xlink:href="/icons/sprites/free.svg#cil-arrow-bottom">
                                            </use>
                                        </svg>)</span></div>
                                <div>Users</div>
                            </div>
                            <div class="dropdown">
                                <button class="btn btn-transparent text-white p-0" type="button"
                                    ...
                                    <svg class="icon">
                                        <use xlink:href="/icons/sprites/free.svg#cil-options">
                                        </use>
                                    </svg>
                                </button>
                        ...
                        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                            <div>
                                <div class="fs-4 fw-semibold">$6.200 <span class="fs-6 fw-normal">(40.9%
                                        <svg class="icon">
                                            <use xlink:href="/icons/sprites/free.svg#cil-arrow-top">
                                            </use>
                                        </svg>)</span></div>
                                <div>Income</div>
                            </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                            ...
                            <button class="btn btn-primary" type="button">
                                <svg class="icon">
                                    <use xlink:href="/icons/sprites/free.svg#cil-cloud-download">
                                    </use>
                                </svg>
                            </button>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="border-start border-start-4 border-start-info px-3 mb-3">
                                                <div class="small text-body-secondary text-truncate">New Clients
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="border-start border-start-4 border-start-danger px-3 mb-3">
                                                <div class="small text-body-secondary text-truncate">Recuring
                                                    Clients</div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="border-start border-start-4 border-start-warning px-3 mb-3">
                                                <div class="small text-body-secondary text-truncate">Pageviews
                                                </div>
                                ...
                                <table class="table border mb-0">
                                    ...
                                    <tbody>
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon" width="24" height="24">
                                                    <use xlink:href="/icons/sprites/flag.svg#cil-flag"></use>
                                                </svg>
    ...
    <script></script>
    <!-- JS personalizado -->
    <script src="js/myjs/adaptacionLateral.js"></script>
</body>
